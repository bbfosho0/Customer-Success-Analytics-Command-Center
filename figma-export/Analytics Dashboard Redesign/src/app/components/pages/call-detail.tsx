...
import { CALLS, AGENTS, fmtDuration, fmtRelative, buildIssueBreakdown } from "../data";
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md border border-border bg-card">
        <div className="grid grid-cols-2 gap-px overflow-hidden rounded-md bg-border md:grid-cols-5">
          ...
          <Field label="Region"><span className="font-mono text-[11px]">{call.region}</span></Field>
          <Field label="Service">{call.service}</Field>
          <Field label="Customer">{call.customer}</Field>
        </div>
      </div>
