...
from .routers import agents, auth, calls, customer_analytics, health, metrics, settings as settings_router
...
async def pydantic_validation_exception_handler(request: Request, exc: ValidationError) -> JSONResponse:
    """Return friendly validation errors raised from dependency models."""

    return _validation_error_response(request, exc.errors())


def _validation_error_response(request: Request, errors: list[dict[str, object]]) -> JSONResponse:
    """Build the shared validation error envelope."""
